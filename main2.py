...
def clear_all():
    globals().clear()  # Clear global variables
    locals().clear()  # Clear local variables
...
def check_all_files(csv_data, dir, folder, avoid_rep=True):
    ...
    for f in current_files:
        try:
            ...
            foutput = "output/csv_data_output_" + folder + "_" + str(countf) + "v6.csv"
