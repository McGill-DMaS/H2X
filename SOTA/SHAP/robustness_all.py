...
with open('result/SHAP_explanations.json', 'r') as f:
...
if __name__ == "__main__":
    ...
    df.to_csv('result/SHAP_robustness_scores.csv', index=False)
...
files = {
    ...
    'SHAP': '../SOTA/SHAP/result/SHAP_explanations_obfuscator.json',
